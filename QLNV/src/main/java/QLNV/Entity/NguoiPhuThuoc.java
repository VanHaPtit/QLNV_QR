...
public class NguoiPhuThuoc {
    ...
    public NguoiPhuThuoc(Long id, NhanVien nhanVien, String hoTenNguoiThan, String quanHe, LocalDate ngaySinh, String maSoThue, LocalDate ngayBatDauGiamTru, LocalDate ngayKetThucGiamTru) {
        this.id = id;
