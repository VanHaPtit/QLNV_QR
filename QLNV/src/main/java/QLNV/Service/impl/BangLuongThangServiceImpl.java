...
import QLNV.Repository.BangLuongThangRepository;
...
@Service
public class BangLuongThangServiceImpl implements BangLuongThangService {

    @Autowired
    private BangLuongThangRepository repo;
    ...
    @Override
    public Optional<BangLuongThang> getById(Long id) {
        return repo.findById(id);
    }

    @Override
    public BangLuongThang save(BangLuongThang bangLuongThang) {
        return repo.save(bangLuongThang);
    }

    @Override
    public BangLuongThang update(Long id, BangLuongThang data) {
    ...
    @Override
    public List<BangLuongThang> findByNhanVien(Long nvId) {
        return repo.findByNhanVienId(nvId);
    }

    @Override
    public List<BangLuongThang> findByThangNam(Integer thang, Integer nam) {
    ...
    @Override
    public List<BangLuongThang> findByNhanVienAndThangNam(Long nvId, Integer thang, Integer nam) {
    ...
    public void importFromExcel(MultipartFile file) throws Exception {
        ...
        for (int i = 1; i <= sheet.getLastRowNum(); i++) {
            ...
            try {
                ...
                Optional<NhanVien> nvOptional = nhanVienRepository.findByMaNv(maNV);
